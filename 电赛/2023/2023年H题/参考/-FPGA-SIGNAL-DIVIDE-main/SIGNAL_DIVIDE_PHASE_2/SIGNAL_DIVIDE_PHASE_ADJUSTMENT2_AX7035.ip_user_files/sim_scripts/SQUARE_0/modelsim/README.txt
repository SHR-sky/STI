...
#
# Generated by export_simulation on Wed Nov 15 14:49:26 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './SQUARE_0.sh' script.

./SQUARE_0.sh -reset_run
...
./SQUARE_0.sh -noclean_files

For more information on the script, please type './SQUARE_0.sh -help'.
